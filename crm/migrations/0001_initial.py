# Generated by Django 5.2.5 on 2025-10-19 05:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=20, validators=[django.core.validators.RegexValidator(message='Phone number must be in +1234567890 or 123-456-7890 format', regex='^(\\+?\\d{1,3}[- ]?)?\\d{3,15}$')])),
            ],
        ),
        migrations.CreateModel(
            name='Product',
